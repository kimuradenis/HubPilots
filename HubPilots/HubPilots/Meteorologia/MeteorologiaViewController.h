...
@interface MeteorologiaViewController : UIViewController <ResultViewProtocol, ADBannerViewDelegate, UITableViewDelegate> {
    
    NSArray *messagesArray;
}

@property (strong, nonatomic) MeteorologiaModel *model;
