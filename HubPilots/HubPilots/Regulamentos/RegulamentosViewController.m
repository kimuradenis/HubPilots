...
#import "RegulamentosViewController.h"
#import "SWRevealViewController.h"


@interface RegulamentosViewController ()

{
    Regulamentos *_currentQuestion;

    UIView *_tappablePortionOfImageQuestion;
    UITapGestureRecognizer *_tapRecognizer;
    UITapGestureRecognizer *_scrollViewTapGestureRecognizer;
    
    RegulamentosResultView *_resultView;
...
@implementation RegulamentosViewController
...
/*    // Add tap gesture recognizer to scrollview
    ...
    //Create Quiz Model
    self.model = [[RegulamentosModel alloc] init];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    _resultView = [[RegulamentosResultView alloc] initWithFrame:CGRectMake(10, 10, self.view.frame.size.width - 20, self.view.frame.size.height - 20)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SocialRegViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
